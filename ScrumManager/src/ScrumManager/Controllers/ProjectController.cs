...
namespace ScrumManager.Controllers
{
    public class ProjectController : Controller
    {
        ...
        public ProjectController()
        {
            ...
            url = "http://localhost:50002/api/projects/1";
        }
        ...
        public async System.Threading.Tasks.Task<JsonResult> Update(Project obj)
        {
            try
            {
                obj = await apiClient.PostObject(obj, url + "/" + obj.ProjectId.ToString(), ApiHttpMethod.PUT);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async System.Threading.Tasks.Task<JsonResult> Delete(Project obj)
        {
            try
            {
                obj = await apiClient.PostObject(obj, url + "/" + obj.ProjectId.ToString(), ApiHttpMethod.DELETE);
            }
            catch (Exception ex)
            {
                throw ex;
