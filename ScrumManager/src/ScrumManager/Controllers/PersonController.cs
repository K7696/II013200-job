...
namespace ScrumManager.Controllers
{
    public class PersonController : Controller
    {
        ...
        public PersonController()
        {
            ...
            url = "http://localhost:50002/api/persons/1";
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async System.Threading.Tasks.Task<JsonResult> Update(Person obj)
        {
            try
            {
                obj = await apiClient.PostObject(obj, url + "/" + obj.PersonId.ToString(), ApiHttpMethod.PUT);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async System.Threading.Tasks.Task<JsonResult> Delete(Person obj)
        {
            try
            {
                obj = await apiClient.PostObject(obj, url + "/" + obj.PersonId.ToString(), ApiHttpMethod.DELETE);
            }
            catch (Exception ex)
            {
                throw ex;
